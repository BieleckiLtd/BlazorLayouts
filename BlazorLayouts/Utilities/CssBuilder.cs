...
namespace BlazorLayouts.Utilities;
...
public struct CssBuilder
{
    ...
    /// <returns>CssBuilder</returns>
    public CssBuilder AddClass(string? value) => value is null ? AddValue(null) : AddValue(" " + prefix + value);
    ...
    /// <param name="when">Condition in which the CSS Class is added.</param>
    /// <returns>CssBuilder</returns>
    public CssBuilder AddClass(string? value, Func<bool>? when = null) => this.AddClass(value, when?.Invoke());
    ...
    /// <param name="when">Condition in which the CSS Class is added.</param>
    /// <returns>CssBuilder</returns>
    public CssBuilder AddClass(Func<string>? value, bool? when = true) => when == true ? this.AddClass(value?.Invoke()) : this;
    ...
    /// <param name="when">Condition in which the CSS Class is added.</param>
    /// <returns>CssBuilder</returns>
    public CssBuilder AddClass(Func<string>? value, Func<bool>? when = null) => this.AddClass(value?.Invoke(), when?.Invoke());
    ...
    /// <param name="when">Condition in which the CSS Class is added.</param>
    /// <returns>CssBuilder</returns>
    public CssBuilder AddClass(CssBuilder builder, bool? when = true) => when == true ? this.AddClass(builder.Build()) : this;
    ...
    /// <param name="when">Condition in which the CSS Class is added.</param>
    /// <returns>CssBuilder</returns>
    public CssBuilder AddClass(CssBuilder builder, Func<bool>? when = null) => this.AddClass(builder, when?.Invoke());
